...
# Remova o 'data_processor2' se você não o fez antes
from src.consumer.data_processor import DataProcessor
from src.models.db_models import ViagemDB # ViagemDB precisa ser importado aqui também
...
def test_process_valid_message(sample_valid_message):
    # Alteração aqui: forneça um config básico de Kafka
